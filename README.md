...
Klasik form üzerinden ürün ekleme kısmına girebilmek için sisteme giriş yapmanız gerekiyor. Local stroge dan aldığım kullanıcı adı : selahattin , şifre:12345 değerleri ile giriş yapılabiliyor. 
Giriş yapıldığında sağ üst kısımda log in butonu log out olarak değişmektedir. 
...
Tüm bu durumların ekran görüntüleri eklenmiştir.
